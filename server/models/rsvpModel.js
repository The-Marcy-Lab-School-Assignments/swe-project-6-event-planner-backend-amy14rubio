...
// Returns a flat array of rsvp_ids that a user has rsvp'd
...
// Rsvps an event: ON CONFLICT DO NOTHING silently skips duplicate rsvps
// Returns the new row, or null if the user had already rsvp'd this event
